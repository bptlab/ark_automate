  ...
  elements: [
    {
      ...
      name: 'SecondActivity',
      id: 'Activity_0frqu31',
      predecessorIds: ['Activity_02jyuh0'],
      successorIds: ['Activity_00ydbo0'],
    ...
    },
    {
      ...
      name: 'ThirdActivity',
      id: 'Activity_00ydbo0',
      predecessorIds: ['Activity_0frqu31'],
      successorIds: ['Event_1wphn90'],
    ...
    },
    {
      ...
      id: 'Event_1cnr8ow',
      predecessorIds: [],
      successorIds: ['Activity_02jyuh0'],
    },
    {
      type: 'INSTRUCTION',
      name: 'FirstActivity',
      id: 'Activity_02jyuh0',
      predecessorIds: ['Event_1cnr8ow'],
      successorIds: ['Activity_0frqu31'],
      rpaApplication: 'Excel.Files',
    ...
    },
    {
      ...
      name: '',
      id: 'Event_1wphn90',
      predecessorIds: ['Activity_00ydbo0'],
      successorIds: [],
    },
  ],
};
