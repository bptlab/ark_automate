import { setRobotMetadata } from '../../sessionStorage/localSsotController/ssot';
import { initSessionStorage } from '../../sessionStorage/sessionStorageUtils';
...
describe('Parsing Tests', () => {
  it('successfully parses the bpmn to ssot', async () => {
    ...
    const Ssot = await parseBpmnToSsot(BPMN_XML, ROBOT_ID);
