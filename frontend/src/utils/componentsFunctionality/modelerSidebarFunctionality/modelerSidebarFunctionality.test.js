...
jest.mock('../../sessionStorageUtils/localSsotController/attributes');
jest.mock('../../sessionStorageUtils/localSsotController/ssot');
...
import {
  setRpaTask,
  setRpaApplication,
} from '../../sessionStorageUtils/localSsotController/attributes';
import {
  setSingleParameter,
  setOutputValueName,
  getParameterObject,
} from '../../sessionStorageUtils/localSsotController/parameters';
...
import { upsert } from '../../sessionStorageUtils/localSsotController/ssot';
